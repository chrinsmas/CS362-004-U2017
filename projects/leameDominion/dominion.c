...
//Bug: Adventurer card holds onto Adventurer card after being played
//Added: argument int handPos, discardCard().
//Bug code
...
int play_adventurer(struct gameState *state, int handPos)
{
        ...
        //Bug Fixed: discard card from hand
...
//Bug Fixed: state->numActions = state->numActions + 2 to
...
int play_village(struct gameState *state, int handPos)
{
        ...
        //Bug Fixed:+2 Actions: +2 actions - 1 action to play village
        state->numActions = state->numActions + 1;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
        ...
        {
        case adventurer:
                return play_adventurer(state, handPos);
